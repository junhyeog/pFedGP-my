...
if __name__ == "__main__":
    ...
    # # ##### OPTUNA #######
    os.makedirs("studys", exist_ok=True)
    study_name = f"{args.exp_name}/env:{args.env}_seed:{args.seed}_d:{args.data_name}_a:{args.alpha}_gdt:{args.get_data_type}"
    ...
    storage = optuna.storages.RDBStorage(
        url=f"sqlite:///studys/{study_name}.db",
